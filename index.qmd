...
- Model intterpretation: Coefficients.
...
- As complexity increases, bias *decreases* (the mean of a model’s predictions is closer to the true mean).
- As complexity increases, variance (the variance about the mean of a model’s predictions) may *first* decrease, and then it *increases* as the predictions become more *wild*
...
- **Adjusted R-squared is lower, but is a 0.04 difference significant?**
...
This is because the reduced model is *nested* within the full model.
